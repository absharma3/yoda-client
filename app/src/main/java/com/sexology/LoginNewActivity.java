    ...
    public void showSingUp(View view) {
        ...
        a.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                rootLayout.setBackgroundColor(ContextCompat.getColor(LoginNewActivity.this, R.color.colorPrimary));
                ((View) animationSquare.getParent()).setBackgroundColor(ContextCompat.getColor(LoginNewActivity.this, R.color.colorPrimary));
    ...
    public void showLogIn(View view) {
        ...
        a.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation arg0) {
                ...
                rootLayout.setBackgroundColor(ContextCompat.getColor(LoginNewActivity.this, R.color.colorAccent));
                ((View) animationSquare.getParent()).setBackgroundColor(ContextCompat.getColor(LoginNewActivity.this, R.color.colorAccent));
